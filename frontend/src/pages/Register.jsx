...
import car from "../assets/images/clouds.webp";
    ...
    <div className="h-screen flex items-center bg-White">
      <div className="flex flex-col md:basis-1/2 items-center">
        <div className="flex flex-col items-center justify-center">
          <p className="p-4 text-6xl md:text-7xl font-bold Barlow Semi Condensed">
            Hi there!
          </p>
        ...
        >
          ...
          {error && <p className="pb-4 text-red-600">Something went wrong!</p>}
          <p className="pb-4">
            Already registered?{" "}
        ...
        <div data-carousel="slide">
          <div className="relative overflow-hidden">
            <div className="duration-700 ease-in-out" data-carousel-item>
              <img src={car} className="object-cover h-screen" alt="..." />
            </div>
          </div>
        </div>
      </div>
