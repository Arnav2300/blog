    ...
    <div className="h-screen flex items-center bg-White">
      <div className="flex flex-col md:basis-1/2 items-center">
        ...
        >
          ...
          <button
            type="submit"
            className="text-White bg-Teal hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 w-60 md:w-72 disabled:cursor-not-allowed disabled:bg-blue-300"
            disabled={isFetching}
          >
            Log In
          </button>
